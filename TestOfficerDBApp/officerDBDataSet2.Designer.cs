...
namespace TestOfficerDBApp {
    ...
    public partial class officerDBDataSet2 : global::System.Data.DataSet {
        ...
        public partial class offendersDataTable : global::System.Data.TypedTableBase<offendersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public offendersRow AddoffendersRow(string LastName, string FirstName, string Gender, System.DateTime DOB) {
...
namespace TestOfficerDBApp.officerDBDataSet2TableAdapters {
    ...
    public partial class offendersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[offenders] WHERE (([offenderID] = @Original_offenderID) AND ([LastName] = @Original_LastName) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[offenders] ([LastName], [FirstName], [Gender], [DOB]) VALUES (" +
                "@LastName, @FirstName, @Gender, @DOB);\r\nSELECT offenderID, LastName, FirstName, " +
                "Gender, DOB FROM offenders WHERE (offenderID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[offenders] SET [LastName] = @LastName, [FirstName] = @FirstName, [Gender] = @Gender, [DOB] = @DOB WHERE (([offenderID] = @Original_offenderID) AND ([LastName] = @Original_LastName) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)));
SELECT offenderID, LastName, FirstName, Gender, DOB FROM offenders WHERE (offenderID = @offenderID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT offenderID, LastName, FirstName, Gender, DOB FROM dbo.offenders";
        ...
        public virtual int Delete(int Original_offenderID, string Original_LastName, string Original_FirstName, string Original_Gender, global::System.Nullable<global::System.DateTime> Original_DOB) {
        ...
        public virtual int Insert(string LastName, string FirstName, string Gender, global::System.Nullable<global::System.DateTime> DOB) {
            if ((LastName == null)) {
        ...
        public virtual int Update(string LastName, string FirstName, string Gender, global::System.Nullable<global::System.DateTime> DOB, int Original_offenderID, string Original_LastName, string Original_FirstName, string Original_Gender, global::System.Nullable<global::System.DateTime> Original_DOB, int offenderID) {
            if ((LastName == null)) {
                throw new global::System.ArgumentNullException("LastName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(offenderID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, string FirstName, string Gender, global::System.Nullable<global::System.DateTime> DOB, int Original_offenderID, string Original_LastName, string Original_FirstName, string Original_Gender, global::System.Nullable<global::System.DateTime> Original_DOB) {
            return this.Update(LastName, FirstName, Gender, DOB, Original_offenderID, Original_LastName, Original_FirstName, Original_Gender, Original_DOB, Original_offenderID);
        }
    }
